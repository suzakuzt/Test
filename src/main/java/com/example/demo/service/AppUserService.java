...
//    String Tokenapp(String urltest) throws Exception;
  ...
  *42.订单文件映射关系
  **/
 String modifyOrderMappingRelationship(String urltest, String json) throws Exception;

 /*
  *43.订单处理
  **/
 String orderfilehandel(String urltest, String json) throws Exception;


 /*
  *44.订单导入历史记录
  **/
 String orderfilehistory(String urltest, String token) throws Exception;


 /*
  *45.订单文件预览
  **/
 String orderfilepreview(String urltest, String token) throws Exception;
